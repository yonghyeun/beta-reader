...
const buttonVariants = cva(
  "flex items-center justify-center transition-bg duration-150",
  {
    variants: {
      size: {
      ...
      variant: {
        ...
        white:
          "bg-secondary-white text-secondary-black hover:bg-secondary-100 disabled:bg-secondary-700 disabled:text-secondary-300"
      },
      rounded: {
        md: "rounded-xl",
        full: "rounded-full"
